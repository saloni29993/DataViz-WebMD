...
for t in data_topics:
	...
	for q in question:
		#extract disease
		disease_question = dl.get_close_matches(q['questionTitle'],diseases,10,0.6)
		disease_content = dl.get_close_matches(q['questionContent'],diseases,10,0.6)
		med_diseases = disease_question + disease_content

		#extract symptom
		symptom_question = dl.get_close_matches(q['questionTitle'],symptoms,10,0.6)
		symptom_content = dl.get_close_matches(q['questionContent'],symptoms,10,0.6)
...
text_file = open("sal_topics.json", "w")
